...
python recYnH.py align -p Y3H -i1 ./example/db/2nd_RNA_set.fa -i2 ./example/db/2nd_PROTEIN_set.fa -f1 ./example/fastq/2019-01-04_MiSeq/31085-122-WD_S1_L001_R1_001.fastq.gz -f2 ./example/fastq/2019-01-04_MiSeq/31085-122-WD_S1_L001_R2_001.fastq.gz -o ./example/output_RNA/ -n EXP1_W.25k
python recYnH.py align -p Y3H -i1 ./example/db/2nd_RNA_set.fa -i2 ./example/db/2nd_PROTEIN_set.fa -f1 ./example/fastq/2019-01-04_MiSeq/31085-122-WD_S1_L001_R1_001.fastq.gz -f2 ./example/fastq/2019-01-04_MiSeq/31085-122-WD_S1_L001_R2_001.fastq.gz -o ./example/output_RNA/ -n EXP1_WHD.25k
